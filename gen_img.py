...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--sdxl", action="store_true", help="load Stable Diffusion XL model"
    )
    parser.add_argument(
        "--v1", action="store_true", help="load Stable Diffusion v1.x model"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="if specified, load prompts from this module",
    )
    parser.add_argument(
        "--prompter_module_args", type=str, default=None, help="args for prompter module"
    )
    parser.add_argument(
        "--interactive",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="original height for SDXL conditioning",
    )
    parser.add_argument(
        "--original_width",
        type=int,
        default=None,
        help="original width for SDXL conditioning",
    )
    parser.add_argument(
        "--original_height_negative",
        type=int,
        default=None,
        help="original height for SDXL unconditioning",
    )
    parser.add_argument(
        "--original_width_negative",
        type=int,
        default=None,
        help="original width for SDXL unconditioning",
    )
    parser.add_argument(
        "--crop_top", type=int, default=None, help="crop top for SDXL conditioning"
    )
    parser.add_argument(
        "--crop_left", type=int, default=None, help="crop left for SDXL conditioning"
    )
    ...
    parser.add_argument(
        "--no_half_vae", action="store_true", help="do not use fp16/bf16 precision for VAE"
    )
    ...
    parser.add_argument(
        ...
        help="embedding normalization mode",
    )
    parser.add_argument(
        "--guide_image_path", type=str, default=None, nargs="*", help="image to ControlNet"
    )
    parser.add_argument(
        "--highres_fix_scale",
        type=float,
    ...
    parser.add_argument(
        "--control_net_multipliers", type=float, default=None, nargs="*", help="ControlNet multiplier"
    )
    parser.add_argument(
        "--control_net_ratios",
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="enable CLIP Vision Conditioning for img2img with this strength",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Enable Deep Shrink with this depth 1, valid values are 0 to 8",
    )
    parser.add_argument(
        "--ds_timesteps_1",
        type=int,
